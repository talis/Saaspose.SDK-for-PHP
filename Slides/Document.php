...
class SlideDocument {
    ...
    public function GetSlideCount($storageType = "", $storageName = "", $folder = "") {
        try {
    ...
    public function DeleteAllSlides($storageType = "", $storageName = "", $folder = "") {
        try {
            //check whether file is set or not
            if ($this->FileName == "")
                throw new Exception("No file name specified");
    ...
    public function SaveAs($outputPath, $saveFormat, $storageType = "", $storageName = "", $folder = "") {
        try {
            //check whether file is set or not
            if ($this->FileName == "")
                throw new Exception("No file name specified");
