...
class Folder {
    ...
    public function UploadFile($strFile, $strFolder, $storageType = "", $storageName = "") {
        try {
    ...
    public function FileExists($fileName, $storageType = "", $storageName = "") {
        try {
    ...
    public function DeleteFile($fileName, $storageType = "", $storageName = "") {
        try {
            //check whether file is set or not
            //build URI
            if ($fileName == "")
    ...
    public function CreateFolder($strFolder, $storageType = "", $storageName = "") {
        try {
            //build URI
    ...
    public function GetDiscUsage($storageType = "", $storageName = "") {
        try {
            //build URI
    ...
    public function GetFile($fileName, $storageType = "", $storageName = "") {
        try {
            //check whether file is set or not
            if ($fileName == "")
                throw new Exception("No file name specified");
    ...
    public function GetFilesList($strFolder, $storageType = "", $storageName = "") {
        try {
            //build URI
